    ...
    <View className="bg-[#00ccbb] flex-1">
      <SafeAreaView className="z-50">
        <View className="flex-row items-center justify-between p-5">
          ...
          <Text className="text-lg font-light text-white">도움받기</Text>
        </View>

        <View className="z-50 p-6 mx-5 my-2 bg-white rounded-lg shadow-mf">
      ...
      <SafeAreaView className='flex-row items-center space-x-5 bg-white h-28'>
        <Image source={{uri: 'https://links/papareact/com/wrn'}}
        ...
        <TouchableOpacity className='flex-row items-center border border-[#00ccbb] mr-5 mx-4 rounded-lg'>
